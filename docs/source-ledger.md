...
| Manutenção, recondicionamento e monitoramento de material rodante | Confirmado na presença pública | Site anterior | Publicar |
| Reforma de caçambas e conchas | Confirmado na presença pública | Site anterior | Publicar |
| Tratores de esteira, escavadeiras, perfuratrizes e colheitadeiras | Confirmado na presença pública | Site anterior | Publicar |
| Base em Belo Horizonte | Confirmado na presença pública | Site anterior | Publicar |
| Atendimento em todo o Brasil | Declaração do proprietário em 2026-09-01 | Brief desta reconstrução | Publicar com condicionante logística por demanda |
...
- Skava Minas: narrativa visual com máquinas, pessoas, estrutura e projetos,
  sem converter sua presença na carteira em case.
- Google Search Central: conteúdo útil, migração, dados estruturados e política
...
# Expansão por equipamento e território — 08/09/2026

- Pedido do proprietário: ampliar a descoberta por cidades de Minas Gerais e por cilindros de escavadeiras/tratores, aproveitando Ubersuggest. Autorização anterior de push e merge permanece; DNS e Search Console continuam fora do escopo.
