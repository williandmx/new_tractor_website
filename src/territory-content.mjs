...
const territoryBody = ({ pageHero, contactBand, site }) => `
  ...
  <section class="section section--dark" aria-labelledby="corredores-mg-title">
    <div class="shell">
      <div class="section-heading section-heading--split">
        <div><span class="eyebrow eyebrow--light">QUATRO CONTEXTOS DE MINAS</span><h2 id="corredores-mg-title">O perfil do território muda a pergunta.</h2></div>
        <p class="section-copy-light">Quatro contextos ajudam a conectar o problema da máquina ao próximo dado necessário para compras, manutenção e mecânica.</p>
      </div>
      <div class="coverage-grid">
        ${regionCard("01 · RMBH", "Base metropolitana", "Belo Horizonte concentra a base do grupo. Contagem tem distritos industriais e conexões logísticas; Betim reúne indústria, mecânica, serviços e logística. Informe máquina, componente e cidade para encaminhar uma demanda de recuperação, usinagem ou peças.", `<a class="text-link text-link--light" href="/contato/">Informar cidade e componente</a>`)}
  ...
  <section class="section section--sand" aria-labelledby="prioridades-mg-title">
    <div class="shell">
      ...
      <div class="component-grid component-grid--catalog">
        ${priorityCard("01", "RMBH", "Belo Horizonte", "Base real do grupo. Informe se a necessidade envolve rodante, cilindro, estrutura ou peça e se o componente está instalado, removido ou disponível para envio.", "/atuacao/", "Conhecer a atuação")}
        ...
        ${priorityCard("11", "ALTO PARANAÍBA", "Araxá", "O complexo industrial mineral orienta temas de manutenção industrial, peças e recuperação. Relacione o cilindro à máquina e envie identificação, aplicação e condição observada.", "/services/", "Conhecer Services")}
  ...
  ${section(
    ...
    `<p>Comece com fabricante, modelo e identificação da máquina; componente, código ou desenho; fotos e medidas preliminares; peso e dimensões conhecidos; condição instalada ou removida; aplicação, prioridade e restrições de acesso.</p><ul><li><strong>Rodantes:</strong> lado, posição, tipo de componente, terreno, carga, horímetro e histórico de troca ou medição.</li><li><strong>Cilindros:</strong> função, plaqueta, conexões, comportamento observado e histórico do conjunto.</li><li><strong>Usinagem, Calderaria e Parts:</strong> peça, desenho, material conhecido, quantidade, objetivo da consulta e possibilidade de envio.</li><li><strong>Services e TechTractor:</strong> contexto da operação, registros disponíveis e resultado que precisa ser organizado.</li></ul><p>Cada solicitação é avaliada técnica, comercial e logisticamente conforme a peça, a aplicação e a cidade.</p><address>Base: ${site.address}. <a href="${site.phoneHref}">${site.phoneDisplay}</a> · <a href="mailto:${site.email}">${site.email}</a> · <a href="${site.map}" target="_blank" rel="noopener noreferrer">Ver a localização no mapa</a>.</address>`,
  )}
  ${section(
    "fontes-territoriais",
    "Referências públicas de contexto",
    `<p>Conheça as fontes públicas que ajudam a explicar o perfil dos territórios: <a href="https://prefeitura.pbh.gov.br/empreendedor/empreender-em-bh" target="_blank" rel="noopener noreferrer">Prefeitura de Belo Horizonte</a>, portais de <a href="https://portal.contagem.mg.gov.br/superintendencia-de-gestao-de-distritos-e-polos-sedecon/" target="_blank" rel="noopener noreferrer">Contagem</a> e <a href="https://www.betim.mg.gov.br/portal/servicos/1001/o-municipio/" target="_blank" rel="noopener noreferrer">Betim</a>, <a href="https://amif.org.br/pt/levantamento-completo/" target="_blank" rel="noopener noreferrer">AMIF</a>, <a href="https://www.vale.com/pt/onde-estamos" target="_blank" rel="noopener noreferrer">Vale</a>, <a href="https://www.csn.com.br/mineracao/" target="_blank" rel="noopener noreferrer">CSN</a>, <a href="https://www.nexaresources.com/quem-somos/" target="_blank" rel="noopener noreferrer">Nexa</a>, <a href="https://aperambioenergia.com.br/institucional/empresa/historia/" target="_blank" rel="noopener noreferrer">Aperam BioEnergia</a>, <a href="https://kinross.com.br/a-kinross/conheca/" target="_blank" rel="noopener noreferrer">Kinross</a>, <a href="https://cbmm.com/pt/midias/noticias/cbmm-crescimento-diversificacao-niobio" target="_blank" rel="noopener noreferrer">CBMM</a> e <a href="https://www.mills.com.br/maquinas-pesadas/mapa-de-atuacao" target="_blank" rel="noopener noreferrer">Mills</a>. Essas fontes contextualizam setores e localidades, sem indicar vínculo comercial com o Grupo New Tractor.</p><p>Para conhecer a atuação nacional, volte à <a href="/atuacao/">atuação do grupo</a> ou fale pelo <a href="/contato/">canal de contato</a>.</p>`,
  )}
  ${contactBand("Informe a cidade e o componente da sua demanda")}`;
...
export function createTerritoryPages({ pageHero, contactBand, breadcrumbSchema, site }) {
  ...
  return [{
    ...
    description: "Avalie material rodante, recuperação estrutural, usinagem e peças para máquinas pesadas em Minas Gerais, com base em Belo Horizonte.",
    active: "atuacao",
